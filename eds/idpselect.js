...
function IdPSelectLanguages() {
	this.langBundles = {
		en: {
			...
			"idpList.defaultOptionLabel": "Choose from the list...",
			"idpList.showList": "Choose from MGHPCC Partners",
			"idpList.showSearch": "Not a MGHPCC Partner? Search all organizations",
			"submitButton.label": "Continue to Organization",
			helpText: "Help",
...
function IdPSelectUI() {
	...
	var C = function (aP) {
		...
		radio_label.setAttribute("for", "IdPSelectAutoDisp");
		radio_label.appendChild(document.createTextNode(A("autoFollow.time")));
